...
EOF
  ...
  # compilateur récent du NDK en fait une erreur. On la ramène à un simple avertissement (clang
  # déclare alors ces fonctions de la bibliothèque C avec leur vrai type), sans modifier la source.
  # (Forcer « -include string.h » casse loader/loader.c, qui définit son propre basename.)
  export CPPFLAGS="-Wno-error=implicit-function-declaration -I$dep/include -DARG_MAX=131072 -DVERSION=\\\"${PROOT_VERSION}\\\""
